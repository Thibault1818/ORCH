...
import { AUTONOMOUS_LABEL, GOAL_REVIEW_LABEL, GOAL_LEAD_LABEL, DEFAULT_SYSTEM_TEMPLATE, DEFAULT_USER_TEMPLATE, buildPromptContext, GOVERNED_LABEL } from './chunk-LMCD6ZPU.js';
import { commandFailureMessage } from './chunk-OBMT332P.js';
...
var ReviewRunner = class {
  constructor(options, commandRunner, executables, safeguards, owner) {
...
${result.stderr}`.trim() || (result.ok ? "" : commandFailureMessage(result));
      return {
        criterion,
        passed: result.ok,
        output: sanitizeText(output).slice(0, 2e3)
      };
    } catch (error) {
      return {
        criterion,
        passed: false,
        output: sanitizeText(error instanceof Error ? error.message : String(error)).slice(0, 2e3)
      };
    }
  }
};
function reviewEnvironment(executables) {
...
//# sourceMappingURL=chunk-F3DKF5JN.js.map
//# sourceMappingURL=chunk-F3DKF5JN.js.map