...
import { streamingCommandFailureMessage } from './chunk-OBMT332P.js';
...
// src/infrastructure/adapters/shell.ts
  ...
  execute(params) {
    ...
    async function* generateEvents() {
      ...
      if (!completion.ok && !signal?.aborted) {
        throw new Error(completion.termination === "exited" ? `Shell command exited with code ${completion.exitCode}` : streamingCommandFailureMessage(completion, "Shell command"));
      }
    }
...
export { ShellAdapter };
//# sourceMappingURL=shell-NO6ZM425.js.map
//# sourceMappingURL=shell-NO6ZM425.js.map