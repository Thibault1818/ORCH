...
async function create() {
  ...
  const sessions: WorkflowSessionsV1 = { schema_version: 1, job_id: 'wf_safe', codex_thread_id: null, fable_session_id: null, opus_session_id: null, opus_plan_hash: null, modes: { codex: 'none', fable: 'none', opus: 'none' }, rotation_history: [], usage: { codex: { ...empty }, fable: { ...empty }, opus: { ...empty } }, updated_at: now };
